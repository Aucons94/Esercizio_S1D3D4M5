using Esercizio_S1D3D4M5.Models;
using System;
...
namespace Esercizio_S1D3D4M5.Controllers
{
    public class ArticoloController : Controller
    {
        ...
        public ActionResult SalvaModifiche(Articolo prodottoModificato)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Vetrina", new { id = prodottoModificato.Id });
            }

            return View("Vetrina", prodottoModificato);
        }
